...
void performCalculations(double a, double b, double c) {
    ...
    cout << "File1: Variance = " << variance << ", Standard Deviation = " << sqrt(variance) << endl;
}
...
void generateReport(const string& reportType) {
    ...
    cout << "File1: Report generated successfully" << endl;
    for (const string& data : reportData) {
        cout << "File1: " << data << endl;
    }
}
